<template>
  ...
  <el-form-item>
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" label="分类名称" prop="category_name" style="width: 60px;"></el-table-column>
      <el-table-column align="center" label="分类图标" style="width: 60px;">
      <template slot-scope="scope">
      ...
      <el-table-column align="center" label="子分类" width="150" >
      <template slot-scope="scope">
        <el-button type="warning" round @click.native="getsuncategory(scope.row.category_id)">子分类</el-button>
      </template>
      </el-table-column>
